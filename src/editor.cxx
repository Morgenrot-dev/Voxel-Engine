...
int main()
{
  ...
  while(!quit){
    ...
    current.setUniformVec3("lightPos", vec3(1.2f, 5.0f, -2.0f));
    ...
    glm::mat3 normal_model = glm::transpose(glm::inverse(new_model)); 
    ...
    lightProgram.use();
    glm::mat4 new_model = glm::mat4(1.0f);
    new_model = glm::translate(new_model, vec3(1.2f, 5.0f, -2.0f));
